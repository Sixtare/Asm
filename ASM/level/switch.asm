...
;LDA #$01
;STA $141D   ;TENHO QUE ARRUMAR ISSO NA ASAR
...
change_block:
LDA $13CE      ;Sem power up no midway
BEQ +
...
INC $14        ;Continua animação apos morto por algum tempo
	       ;Pros blocos trocarem de visual
.ret
RTS           ;Termina codigo aqui pra evitar switch após morte
...
RTS	       ;Termina o codigo aqui caso tenha terminado o level
	       ;Pra evitar do cara se matar após terminar ele
.notFinished
LDA $18
AND #%00110000
BEQ .return
...
LDA #%00110000 ;Desativando scroll L/R
TRB $17
